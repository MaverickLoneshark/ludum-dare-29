...
<<<<<<< HEAD
				if(projectiles[p].active &&
					(projectiles[p].x[0] >= 0) && (projectiles[p].x[0] < CANVAS_WIDTH) &&
					(projectiles[p].y[0] >= offheight) && (projectiles[p].y[0] < (offheight + CANVAS_HEIGHT)))
				{
=======
				if (    projectiles[p].active 
...
>>>>>>> 28e95eab0f2ac075d158104c165a7a2a7dbdb610
					if(!dirty)
					{
					...
					context.fillRect(projectiles[p].x[0] - 4, projectiles[p].y[0] - offheight - 4, 8, 8);
