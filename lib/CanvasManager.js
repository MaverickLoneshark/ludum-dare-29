...
=======
(function() {
>>>>>>> 36da2c3123d6dd8682dd7107a302cea325d00d3e
	/*-- Constants --*/
		...
		redraw : function(index) {
			...
			for(var p = 0; p < projectiles.length; p++)
			{
				...
				if(projectiles[p].active &&
					(projectiles[p].x[ldGame.projectile_manager.TRAIL_LENGTH - 1] >= 0) && (projectiles[p].x[ldGame.projectile_manager.TRAIL_LENGTH - 1] < CANVAS_WIDTH) &&
					(projectiles[p].y[ldGame.projectile_manager.TRAIL_LENGTH - 1] >= offheight) && (projectiles[p].y[ldGame.projectile_manager.TRAIL_LENGTH - 1] < (offheight + CANVAS_HEIGHT)))
				{
					if(!dirty)
					{
					...
					context.fillRect(projectiles[p].x[ldGame.projectile_manager.TRAIL_LENGTH - 1] - 4, projectiles[p].y[ldGame.projectile_manager.TRAIL_LENGTH - 1] - offheight - 4, 8, 8);
