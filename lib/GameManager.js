...
(function(){
	...
	function generateEnemyProjectile(currentTime)
	{
		...
		if(this.nextMissile <= currentTime)
		{
			...
			var target_x = (Math.random() * ldGame.canvas_manager.CANVAS_WIDTH);
			var velocity = calculateVelocity(origin_x, 0, target_x, ldGame.canvas_manager.CANVAS_HEIGHT * ldGame.canvas_manager.canvases.length);
